...
export async function updateInvoice(prevState: State | undefined, formData: FormData) {
...
export async function signInWithGoogle(e: React.FormEvent<HTMLFormElement>) {
    e.preventDefault();
    await signIn("google");
}
